...
saturn = Planet.create(name: 'Saturn', likes: 0, diameter: '120,536', mass: 95.17, orbital_period: '10,747', day_length: '10.7', sun_distance: '1,433.5', temperature: -140, moons: 62)
uranus = Planet.create(name: 'Uranus', likes: 0, diameter: '51,118', mass: 0.11, orbital_period: '30,589', day_length: '17.2', sun_distance: '2,872.5', temperature: -167, moons: 27)
neptune = Planet.create(name: 'Neptune', likes: 0, diameter: '49,528', mass: 17.24, orbital_period: '59,800', day_length: '16.1',  sun_distance: '4,495.1', temperature: -200, moons: 14)
